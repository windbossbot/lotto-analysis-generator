...
- 최근 4회 기준 중복 겹침과 구간 커버리지를 추가로 반영해 한 구간에 몰린 조합을 더 강하게 밀어냅니다.
...
- 추천 세트 선택은 최근 4회차 겹침과 섹션 중복을 더 강하게 벌점 처리해, 5세트 전체의 커버리지를 넓히는 방향으로 조정했습니다.
